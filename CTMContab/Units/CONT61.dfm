object frmTipoMovActivos: TfrmTipoMovActivos
  Left = 466
  Top = 391
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Tipo de movimiento de Activos'
  ClientHeight = 256
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QTipos: TADOQuery
    ...
    SQL.Strings = (
      'select '
      'EMP_CODIGO, TIP_CODIGO, TIP_NOMBRE, USU_CODIGO'
      'from '
      'tipo_movimientos_activos'
      'where '
    ...
    object QTiposUSU_CODIGO: TIntegerField
  ...
  object Search: TQrySearchDlgADO
    Title = 'Tipo de movimiento de activos'
