object frmInformacionNCF: TfrmInformacionNCF
  Left = 394
  Top = 290
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Informacion NCF'
  ClientHeight = 310
  ClientWidth = 654
  Color = clBtnFace
  ...
  object lburbanizacion: TLabel
    Left = 216
    Top = 224
    Width = 417
    Height = 19
    AutoSize = False
    Caption = 'lburbanizacion'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Tahoma'
