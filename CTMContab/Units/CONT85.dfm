object frmCashflowConceptos: TfrmCashflowConceptos
  Left = 404
  Top = 223
  ActiveControl = DBEdit2
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Cashflow - Conceptos'
  ClientHeight = 257
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QConceptos: TADOQuery
    ...
    SQL.Strings = (
      'select'
      'emp_codigo, GrupoID, SubgrupoID, ConceptoID, Nombre'
      'from'
      'Cashflow_Conceptos'
      'where'
      'emp_codigo = :emp_codigo'
      'order by'
      'GrupoID, SubgrupoID, ConceptoID'
      '')
    Left = 304
    Top = 192
    ...
    object QConceptosGrupoID: TIntegerField
      FieldName = 'GrupoID'
    end
    object QConceptosSubgrupoID: TIntegerField
      FieldName = 'SubgrupoID'
    end
    object QConceptosConceptoID: TIntegerField
