...
type
  TRepBalanceCompAnual = class(TQuickRep)
    QRBand1: TQRBand;
    QRBand2: TQRBand;
    QRLabel21: TQRLabel;
    QRBand3: TQRBand;
...
var
  RepBalanceCompAnual: TRepBalanceCompAnual;
...
procedure TRepBalanceCompAnual.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRepBalanceCompAnual.QCuentasCalcFields(DataSet: TDataSet);
begin
...
procedure TRepBalanceCompAnual.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
  a : integer;
  cambiar : TQRLabel;
