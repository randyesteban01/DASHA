object frmTipoAccionPersonal: TfrmTipoAccionPersonal
  Left = 232
  Top = 345
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Tipos de acci'#243'n de personal'
  ClientHeight = 255
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QTipo: TADOQuery
    ...
    SQL.Strings = (
      'select '
      'emp_codigo, tip_codigo, tip_nombre'
      'from'
  ...
  object Search: TQrySearchDlgADO
    Title = 'Tipos acci'#243'n personal'
