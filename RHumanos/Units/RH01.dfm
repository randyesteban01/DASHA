object frmInstitucion: TfrmInstitucion
  Left = 454
  Top = 174
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Instituciones Acad'#233'micas'
  ClientHeight = 254
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QInstitucion: TADOQuery
    ...
    BeforePost = QInstitucionBeforePost
    AfterPost = QInstitucionAfterPost
    AfterDelete = QInstitucionAfterDelete
    Parameters = <>
    SQL.Strings = (
      'select '
  ...
  object dsInstitucion: TDataSource
    AutoEdit = False
    DataSet = QInstitucion
    OnStateChange = dsInstitucionStateChange
    Left = 344
    Top = 160
  end
  object Search: TQrySearchDlgADO
    Title = 'Instituciones academicas'
    ResultField = 'ins_codigo'
    Query.Strings = (
