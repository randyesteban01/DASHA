object frmCategoriasLic: TfrmCategoriasLic
  Left = 277
  Top = 448
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Categor'#237'a de licencias'
  ClientHeight = 248
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QCategorias: TADOQuery
    ...
    AfterDelete = QCategoriasAfterDelete
    ...
    Left = 312
    Top = 160
    object QCategoriasemp_codigo: TIntegerField
      FieldName = 'emp_codigo'
    end
    object QCategoriascat_codigo: TIntegerField
      FieldName = 'cat_codigo'
    end
    object QCategoriascat_nombre: TStringField
      FieldName = 'cat_nombre'
      Size = 60
    end
  end
