...
procedure TRepEmpleados.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand := QEmpleados.RecordCount > 0;
end;

procedure TRepEmpleados.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
  a : integer;
  cambiar : TQRLabel;
begin
  ...
  begin
    ...
    dm.Query1.Parameters.ParamByName('mod').Value := 'RepEmpleados';
    dm.Query1.Open;
