...
type
  TRValorInvSarita = class(TQuickRep)
    QRBand1: TQRBand;
    lbTitulo: TQRLabel;
    lbFecha: TQRLabel;
...
var
  RValorInvSarita: TRValorInvSarita;
...
procedure TRValorInvSarita.QProductosCalcFields(DataSet: TDataSet);
var
...
procedure TRValorInvSarita.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
