...
type
  TRepRecFPago = class(TQuickRep)
    ...
    QRecibosFOR_MONTO: TFloatField;
    QRecibosREC_FECHA: TDateTimeField;
    QRecibosFOR_DESCRIPCION: TIBStringField;
    QRExpr2: TQRExpr;
...
procedure TRepRecFPago.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
  a : integer;
  cambiar : TQRLabel;
begin
  ...
  begin
    ...
    dm.Query1.Parameters.ParamByName('mod').Value := 'RepRecFPago';
    dm.Query1.Open;
