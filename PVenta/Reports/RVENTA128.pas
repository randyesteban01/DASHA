...
type
  TRFacturaSteelTec = class(TQuickRep)
    QRBand1: TQRBand;
    lbFactura: TQRLabel;
    QRLabel4: TQRLabel;
    QRLabel5: TQRLabel;
...
var
  RFacturaSteelTec: TRFacturaSteelTec;
...
procedure TRFacturaSteelTec.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  a : integer;
begin
...
procedure TRFacturaSteelTec.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
  a : integer;
  cambiar : TQRLabel;
begin
  ...
  if RFacturaSteelTec.QRPrinter.PageNumber = RFacturaSteelTec.QRPrinter.PageCount then
  begin
...
procedure TRFacturaSteelTec.QDetalleCalcFields(DataSet: TDataSet);
var
...
procedure TRFacturaSteelTec.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  t : string;
begin
...
procedure TRFacturaSteelTec.QFacturaCalcFields(DataSet: TDataSet);
begin
...
procedure TRFacturaSteelTec.CorregirError;
var
  mov : string;
begin
  dm.Query1.Close;
...
procedure TRFacturaSteelTec.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Linea := 1;
end;

procedure TRFacturaSteelTec.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  Linea := Linea + 1;
...
procedure TRFacturaSteelTec.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRFacturaSteelTec.ChildBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  dm.Query1.Close;
  dm.Query1.SQL.Clear;
