...
type
  TRCuadreCaceres = class(TQuickRep)
    QRBand1: TQRBand;
    lbTitulo: TQRLabel;
...
var
  RCuadreCaceres: TRCuadreCaceres;
...
procedure TRCuadreCaceres.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  dm.Query1.Close;
  dm.Query1.SQL.Clear;
...
procedure TRCuadreCaceres.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
