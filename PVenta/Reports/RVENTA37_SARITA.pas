...
type
  TREntradaAlmSarita = class(TQuickRep)
    QRBand1: TQRBand;
    QRLabel3: TQRLabel;
    QRLabel4: TQRLabel;
    QRLabel5: TQRLabel;
...
var
  REntradaAlmSarita: TREntradaAlmSarita;
...
procedure TREntradaAlmSarita.QDetalleCalcFields(DataSet: TDataSet);
var
...
procedure TREntradaAlmSarita.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
  a : integer;
  cambiar : TQRLabel;
...
procedure TREntradaAlmSarita.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TREntradaAlmSarita.QEntradaAfterOpen(DataSet: TDataSet);
begin
  QSerie.Open;
  qSucursal.Open;
end;

procedure TREntradaAlmSarita.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
