...
procedure TRCotizacion.QDetalleCalcFields(DataSet: TDataSet);
var
...
procedure TRCotizacion.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  ...
  lbEmp1.Enabled := Imprime;
  lbEmp2.Enabled := Imprime;
  lbEmp3.Enabled := Imprime;
  lbEmp4.Enabled := Imprime;
  lbEmp5.Enabled := Imprime;
  lbEmp6.Enabled := Imprime;
  lbEmp7.Enabled := Imprime;
  lbEmp8.Enabled := Imprime;
  lbEmp9.Enabled := Imprime;}
  ...
  dm.Query1.Parameters.ParamByName('tfa').Value := 1;
  dm.Query1.Open;

  ImprimeEncaqbezado := dm.Query1.fieldbyname('tfa_imprimie_encabezado').AsString;
   }
  //IMPRIMIR LOGO
  if (Trim(dm.QParametrospar_imprime_logo.Value) = 'True') and (ImprimeEncaqbezado = 'True') then begin
  ...
  lbEmp2.Top     := 64;
  //LOCALIDAD
  lbEmp3.Enabled := lbEmp2.Enabled;
  lbEmp3.Top     := 76;
  //TELEFONO
  lbEmp4.Enabled := lbEmp2.Enabled;
  lbEmp6.Enabled := lbEmp2.Enabled;
  lbEmp8.Enabled := lbEmp2.Enabled;
  lbEmp4.top     := 88;
  lbEmp6.Top     := lbEmp4.top;
  lbEmp8.Top     := lbEmp4.top;

  //RNC
  lbEmp5.Enabled := lbEmp2.Enabled;
  lbEmp7.Enabled := lbEmp2.Enabled;
  lbEmp9.Enabled := lbEmp2.Enabled;
  lbEmp5.top      := 100;
  lbEmp7.Top     := lbEmp5.top;
  lbEmp9.Top     := lbEmp5.top;

  QRDBImage1.Height := 64;
  QRDBImage1.Width  := 271;
  end
  else
  if (Trim(dm.QParametrospar_imprime_logo.Value) = 'True') and (ImprimeEncaqbezado = 'false') then begin
  IF DM.QEmpresasEMP_LOGO.IsNull THEN begin
  lbEmp1.Enabled := True;
  QRDBImage1.Enabled := False;
  END
  ...
  lbEmp8.Enabled := lbEmp2.Enabled;
  lbEmp4.top     := 64;
  lbEmp6.Top     := lbEmp5.top;
  lbEmp8.Top     := lbEmp5.top;
  ...
  QRDBImage1.Height := 110;
  QRDBImage1.Width  := 441;
  end
  else
  if (Trim(dm.QParametrospar_imprime_logo.Value) = 'False') and (ImprimeEncaqbezado = 'True') then begin
  QRDBImage1.Enabled := False;
  lbEmp1.Enabled := True;
  //DIRECCION
  lbEmp2.Enabled := True;
  ...
  QRDBImage1.Height := 104;
  QRDBImage1.Width  := 441;
  end
  else
  if (Trim(dm.QParametrospar_imprime_logo.Value) = 'False') and (ImprimeEncaqbezado = 'false') then begin
  QRDBImage1.Enabled := False;
  lbEmp1.Enabled := False;
  //DIRECCION
  lbEmp2.Enabled := False;
...
procedure TRCotizacion.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRCotizacion.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
