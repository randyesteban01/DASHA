object frmRepInvFamiliaDepto: TfrmRepInvFamiliaDepto
  Left = 348
  Top = 244
  ActiveControl = edAlma
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Reporte de Inventario por Familia y Departamento'
  ClientHeight = 197
  ClientWidth = 425
  Color = clBtnFace
  ...
  object ckimpuesto: TCheckBox
    Left = 80
    Top = 112
    Width = 161
    Height = 17
    Caption = 'Incluir Impuesto en el costo'
    TabOrder = 8
  end
  object tDepto: TEdit
    Left = 160
  ...
  object ckemp: TCheckBox
    Left = 80
    Top = 128
    Width = 113
    Height = 17
    Caption = 'Imprimir Empaques'
    TabOrder = 10
  end
