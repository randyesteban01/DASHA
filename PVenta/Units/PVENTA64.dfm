object frmConsPedidosProv: TfrmConsPedidosProv
  Left = 561
  Top = 260
  ...
  object QPedidos: TADOQuery
    ...
    SQL.Strings = (
      ...
      'p.SUP_CODIGO, p.VEN_CODIGO, u.usu_nombre, p.suc_codigo,'
      'p.ped_solicitud_compra, m.mon_sigla'
      'from'
      'PEDIDOS p'
      'left outer join moneda m on (p.emp_codigo = m.emp_codigo'
      'and p.mon_codigo = m.mon_codigo),'
      'usuarios u'
      'where '
      'p.emp_codigo = :emp'
      'and p.ped_tipo = '#39'S'#39
    ...
    object QPedidosmon_sigla: TStringField
      FieldName = 'mon_sigla'
      Size = 5
    end
  ...
  object QDetalle: TADOQuery
    ...
    SQL.Strings = (
      ...
      'DET_DESCUENTO, DET_FACTURADO, DET_STATUS, DET_MEDIDA,'
      'det_despachado'
      'from DET_PEDIDO'
      'where '
