object DM: TDM
  ...
  object IBDatabase: TIBDatabase
    Connected = True
    DatabaseName = 'D:\Delphi\Softwares\SIGMA\CTMPV.GDB'
    Params.Strings = (
      'user_name=sysdba'
      'password=masterkey')
    LoginPrompt = False
  ...
  object QParametros: TIBQuery
    ...
    SQL.Strings = (
        ...
        'IO, PAR_FORMATOCON, PAR_CAJA, PAR_IMPCODIGOBARRA, CPA_CODIGOCLIE' +
        'NTE, PAR_LIMITEINICIAL, PAR_MOVCK,'
      'PAR_MOVCARGO'
      'from PARAMETROS'
  ...
  object UPDParametros: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  PAR_CAJA = :PAR_CAJA,'
      '  PAR_IMPCODIGOBARRA = :PAR_IMPCODIGOBARRA,'
      '  CPA_CODIGOCLIENTE = :CPA_CODIGOCLIENTE,'
      '  PAR_LIMITEINICIAL = :PAR_LIMITEINICIAL,'
      '  PAR_MOVCK = :PAR_MOVCK,'
      '  PAR_MOVCARGO = :PAR_MOVCARGO'
      'where'
    ...
    InsertSQL.Strings = (
      'insert into PARAMETROS'
        ...
        '   PAR_BHORA2, PAR_FACMODPRECIO, PAR_FORMATOCON, PAR_CAJA, PAR_I' +
        'MPCODIGOBARRA, '
      
        '   CPA_CODIGOCLIENTE, PAR_LIMITEINICIAL, PAR_MOVCK, PAR_MOVCARGO' +
        ')'
      'values'
        ...
        '   :PAR_IMPCODIGOBARRA, :CPA_CODIGOCLIENTE, :PAR_LIMITEINICIAL, ' +
        ':PAR_MOVCK, '
      '   :PAR_MOVCARGO)')
    DeleteSQL.Strings = (
