object frmMotivoDevolucion: TfrmMotivoDevolucion
  Left = 324
  Top = 200
  BorderIcons = [biSystemMenu, biMinimize, biHelp]
  BorderStyle = bsSingle
  Caption = 'Motivos de devoluci'#243'n de mercancia'
  ClientHeight = 255
  ClientWidth = 549
  Color = clBtnFace
  ...
  object QMotivos: TADOQuery
    ...
    BeforePost = QMotivosBeforePost
    AfterPost = QMotivosAfterPost
    AfterDelete = QMotivosAfterDelete
    OnNewRecord = QMotivosNewRecord
    ...
    SQL.Strings = (
      'select '
      'emp_codigo, mot_codigo, mot_nombre'
      'from'
      'Motivo_Devolucion'
      'where'
    ...
    Left = 416
    Top = 96
    object QMotivosemp_codigo: TIntegerField
  ...
  object dsMotivos: TDataSource
    AutoEdit = False
    DataSet = QMotivos
    OnStateChange = dsMotivosStateChange
    Left = 440
    Top = 112
  end
