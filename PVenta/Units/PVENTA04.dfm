object frmTipoClientes: TfrmTipoClientes
  Left = 452
  Top = 421
  ...
  object QTipo: TADOQuery
    ...
    SQL.Strings = (
      'select EMP_CODIGO, TCL_CODIGO, TCL_NOMBRE, TCL_PRECIO'
      ' from TIPOCLIENTES'
    ...
    object QTipoTCL_CODIGO: TIntegerField
      FieldName = 'TCL_CODIGO'
    end
    object QTipoTCL_NOMBRE: TIBStringField
      FieldName = 'TCL_NOMBRE'
      Size = 60
    end
    object QTipoTCL_PRECIO: TStringField
      FieldName = 'TCL_PRECIO'
      Size = 8
    end
  end
