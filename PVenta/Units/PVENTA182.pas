...
type
  TfrmCajasIP = class(TForm)
    ...
    Label3: TLabel;
    DBEdit3: TDBEdit;
    CBcodigo_abre_caja: TDBComboBox;
    ...
    dbrgrpTipoLector: TDBRadioGroup;
    QCajasTipo_Lector: TIntegerField;
    dbrgrpcodigo_abre_caja_tipo: TDBRadioGroup;
    QCajascodigo_abre_caja_tipo: TStringField;
    qSucursal: TADOQuery;
    IntegerField1: TIntegerField;
    DS_Sucursal: TDataSource;
    Label13: TLabel;
    DBLookupCombox3: TDBLookupComboBox;
    qSucursalsuc_codigo: TIntegerField;
    qSucursalsuc_nombre: TStringField;
    qSucursalsuc_status: TStringField;
    QCajassuc_codigo: TIntegerField;
    ...
    procedure dsCajasDataChange(Sender: TObject; Field: TField);
  private
...
procedure TfrmCajasIP.DBLookupComboBox2Click(Sender: TObject);
begin
qSucursal.Close;
qSucursal.Parameters.ParamByName('emp_codigo').Value := DBLookupComboBox2.KeyValue;
qSucursal.Open;
end;

procedure TfrmCajasIP.dsCajasDataChange(Sender: TObject; Field: TField);
begin
qSucursal.Close;
qSucursal.Parameters.ParamByName('emp_codigo').Value := DBLookupComboBox2.KeyValue;
qSucursal.Open;
