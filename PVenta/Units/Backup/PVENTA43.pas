...
begin
   totalizar;
  if lbPendiente.caption <> '0.0000' then
  begin
...
begin
  ...
  //begin
    ...
    Pendiente := Pendiente;
    Pagado := Pagado;
    lbPendiente.caption := FormatCurr('#,0.0000',Pendiente);
    lbPagado.caption := FormatCurr('#,0.0000',Pagado);
  //end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      QFormaPagoFOR_MONTO.Value := StrToFloat(Trim(frmMontoFPago.edMonto.Text));
