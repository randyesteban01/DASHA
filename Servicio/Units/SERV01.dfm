object frmTipoEquipos: TfrmTipoEquipos
  Left = 385
  Top = 205
  ...
  object QTipo: TADOQuery
    ...
    SQL.Strings = (
      'select '
      'EMP_CODIGO, TIP_CODIGO, TIP_NOMBRE, TIP_DIAS_ENTREGA'
      'from '
      'tipo_equipos'
      'where '
    ...
    object QTipoTIP_DIAS_ENTREGA: TIntegerField
